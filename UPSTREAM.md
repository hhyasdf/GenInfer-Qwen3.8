...
This directory is a copy of [sgl-project/mini-sglang](https://github.com/sgl-project/mini-sglang) plus the gen-inference contract. It is not a submodule, and the tree is not the content of the commit below.

- repo: https://github.com/sgl-project/mini-sglang
- reference commit (main, 2026-09-22): `9a91cfafe754aa85daee49998176275667eb58f2`

The family list the skill trusts is `python/minisgl/models/register.py`, checked against `references/models/llm-decoder.md` by `scripts/check_contracts.py`. Diffusion, encoder-only, ROCm, and Vulkan stay out of scope.
