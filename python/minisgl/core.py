...
class Context:
    ...
    # Per-request recurrent state for GDN (linear-attention) layers, set by
    # models that need it (e.g. qwen35). Maps layer_id -> state object.
    gdn_state: dict | None = field(default=None, init=False)
