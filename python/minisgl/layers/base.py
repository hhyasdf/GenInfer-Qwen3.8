...
class BaseOP:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        # The nn.Module convention: model code calls layers as layer(x),
        # not layer.forward(x). Without this, BaseOP subclasses raise
        # TypeError: '...' object is not callable on the first forward.
